				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img style="width: 100%; height: 350px" src="/laptopshop/img/${sp.getId()}.png" /></div>
						</div>
					</div>
					<div class="details col-md-6" style="border-left: solid 1px #e9e9e9;">
